          ...
          children: <Widget>[
            Expanded(
              ...
              child: Stack(
                children: <Widget>[
                  Hero(
                    tag: "product_${widget.name.toString()}",
                  ...
                  Align(
                      ...
                      child: Padding(
                        ...
                        child: IconButton(
                          ...
                          color:
                              MyApp.wishList.products.contains(widget.name)
                                  ? Colors.redAccent
                                  : Colors.white,
                          onPressed: () => toggle(),
                        ),
            ...
            FlatButton(
              ...
              onPressed: () {
                MyApp.shoppingBasket.addProductToBasket(widget, 1);
                key.currentState.showSnackBar(new SnackBar(
                  content: new Text(
                      "${widget.name} has been added to your basket"),
                ));
              },
